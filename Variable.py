...
def main():
    ...
    #Tuples Python Là 1 giá trị bất biến khi khai báo vào không thể thay đổi được
    ...
    #Python Dictionary (associative"adj": Tính Liên kết, tập hợp) nó giống như 1 mảng tập hợp hoặc là 1 nó khá giống object
    # dict = {}
